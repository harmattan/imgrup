/****************************************************************************
** Meta object code from reading C++ file 'exttools.h'
**
** Created: Tue Jun 5 22:35:10 2012
...
#error "The header file 'exttools.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Tools[] = {
    "Tools\0\0linktoshare\0share_link(QString)\0"
};
...
int Tools::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: share_link((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
